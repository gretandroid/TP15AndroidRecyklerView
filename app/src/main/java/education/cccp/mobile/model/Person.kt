...
data class Person(
    ...
    companion object {
        ...
        const val CREATE_TABLE_PERSON =
            "CREATE TABLE $TABLE_PERSON($TABLE_PERSON_COL_ID INTEGER PRIMARY KEY AUTOINCREMENT, $TABLE_PERSON_COL_FIRST_NAME TEXT NOT NULL, $TABLE_PERSON_COL_LAST_NAME TEXT NOT NULL, $TABLE_PERSON_COL_NICKNAME TEXT NOT NULL, $TABLE_PERSON_COL_EMAIL TEXT NOT NULL);"
    }
}